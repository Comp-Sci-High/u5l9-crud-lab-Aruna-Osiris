...
app.post("/add/country", async(req,res) => {
  const  country = await new Country({
    ...
    officialLanguage: req.body.language,
...
app.patch("/country/update/earth", async(req,res) =>{
...
// Test this route on post man
app.delete("/country/delete/earth", async(req,res) =>{
...
async function startServer() {
  ...
  await mongoose.connect("mongodb+srv://SE12:CSH2025@cluster0.gc1au.mongodb.net/countries?retryWrites=true&w=majority&appName=Cluster0");
